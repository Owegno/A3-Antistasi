...
if (A3A_has3CBFactions) then {call compile preProcessFileLineNumbers "Templates\3CB\3CBFactions_Logistics_Nodes.sqf"};
if (A3A_has3CBBAF) then {call compile preProcessFileLineNumbers "Templates\3CB\3CBBAF_Logistics_Nodes.sqf"};
